...
-- vim.keymap.set('n', '<leader>fF', '', { callback = function() telescope.find_files({ hidden = true, no_ignore = true }) end })
vim.keymap.set('n', '<leader>fF', '', { callback = telescope.find_files({ hidden = true, no_ignore = true }) })
